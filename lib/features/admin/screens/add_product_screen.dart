...
import 'package:emart/common/widgets/custom_button.dart';
import 'package:emart/common/widgets/custom_textfield.dart';
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 10,),
                CustomTextField(controller: descriptionController, hintText: 'Product Description',maxLines: 7,),
                const SizedBox(height: 10,),
                CustomTextField(controller: priceController, hintText: 'Product Price'),
                const SizedBox(height: 10,),
                CustomTextField(controller: quantityController, hintText: 'Product Quantity'),
                const SizedBox(height: 10,),
                SizedBox(
                  width: double.infinity,
